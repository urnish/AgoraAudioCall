...
public class EngineEventListener extends IRtcEngineEventHandler
    ...
    public void onJoinChannelSuccess(String channel, int uid, int elapsed) {
        ...
        Log.e("1111","onJoinChannelSuccess_"+size);
        if (size > 0) {
    ...
    public void onConnectionStateChanged(int status, int reason) {
        int size = mListeners.size();
        Log.e("444","onConnectionStateChanged_"+status+"_"+reason);
        if (size > 0) {
    ...
    public void onMessageReceived(RtmMessage rtmMessage, String peerId) {
        Log.e("555","onMessageReceived");
    }

    @Override
    public void onTokenExpired() {
        Log.e("666","onTokenExpired");
    }

    @Override
    public void onPeersOnlineStatusChanged(Map<String, Integer> map) {
        int size = mListeners.size();
        Log.e("777","onPeersOnlineStatusChanged"+size);
        if (size > 0) {
    ...
    public void onLocalInvitationReceivedByPeer(LocalInvitation localInvitation) {
        ...
        Log.e("888","onLocalInvitationReceivedByPeer"+size);
        if (size > 0) {
    ...
    public void onLocalInvitationAccepted(LocalInvitation localInvitation, String response) {
        int size = mListeners.size();
        Log.e("999","onLocalInvitationAccepted"+size);
        if (size > 0) {
    ...
    public void onLocalInvitationRefused(LocalInvitation localInvitation, String response) {
        int size = mListeners.size();
        Log.e("000","onLocalInvitationRefused_");
        if (size > 0) {
    ...
    public void onLocalInvitationCanceled(LocalInvitation localInvitation) {
        int size = mListeners.size();
        Log.e("123","onLocalInvitationCanceled"+size);
        if (size > 0) {
    ...
    public void onLocalInvitationFailure(LocalInvitation localInvitation, int errorCode) {
        int size = mListeners.size();
        Log.e("456","onLocalInvitationFailure"+size);
        if (size > 0) {
    ...
    public void onRemoteInvitationReceived(RemoteInvitation remoteInvitation) {
        int size = mListeners.size();
        Log.e("789","onRemoteInvitationReceived"+size);
        if (size > 0) {
    ...
    public void onRemoteInvitationAccepted(RemoteInvitation remoteInvitation) {
        int size = mListeners.size();
        Log.e("901","onRemoteInvitationAccepted"+size);
        if (size > 0) {
    ...
    public void onRemoteInvitationRefused(RemoteInvitation remoteInvitation) {
        int size = mListeners.size();
        Log.e("234","onRemoteInvitationRefused"+size);
        if (size > 0) {
    ...
    public void onRemoteInvitationCanceled(RemoteInvitation remoteInvitation) {
        int size = mListeners.size();
        Log.e("567","onRemoteInvitationCanceled"+size);
        if (size > 0) {
    ...
    public void onRemoteInvitationFailure(RemoteInvitation remoteInvitation, int errorCode) {
        int size = mListeners.size();
        Log.e("890","onRemoteInvitationFailure"+size);
        if (size > 0) {
