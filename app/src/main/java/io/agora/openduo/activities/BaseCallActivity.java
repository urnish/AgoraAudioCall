...
public abstract class BaseCallActivity extends BaseRtcActivity implements RtmChannelListener,
        ResultCallback<Void> {
    ...
    protected void inviteCall(final String peerUid, final String channel) {
        Log.e("AAAA","inviteCall"+peerUid+"_"+channel);
    ...
    protected void answerCall(final RemoteInvitation invitation) {
        Log.e("BBBB","answerCall"+invitation.getResponse());
    ...
    protected void cancelLocalInvitation() {
        Log.e("CCC","cancelLocalInvitation");
    ...
    protected void refuseRemoteInvitation(@NonNull RemoteInvitation invitation) {
        Log.e("DDD","refuseRemoteInvitation");
    ...
    public void onRemoteInvitationReceived(RemoteInvitation remoteInvitation) {
        Log.i("BaseActivity", "onRemoteInvitationReceived from caller:" +
                remoteInvitation.getCallerId());
        global().setRemoteInvitation(remoteInvitation);
        gotoCallingActivity(remoteInvitation.getContent(),
                remoteInvitation.getCallerId(), Constants.ROLE_CALLEE);
    }
